      ...
      <div className="flex-1 bg-white border border-zinc-200 rounded-xl p-6 shadow-sm">
        {activeStep === 1 && (
          <div className="space-y-4 animate-fade-in">
            ...
            <button onClick={() => setActiveStep(2)} className="mt-6 flex items-center gap-2 bg-indigo-600 hover:bg-indigo-700 text-white px-4 py-2 rounded-lg text-sm font-bold shadow-sm">
        ...
        {activeStep === 2 && (
          <div className="space-y-4 animate-fade-in">
            ...
            <button onClick={() => setActiveStep(3)} className="mt-6 bg-zinc-900 hover:bg-zinc-800 text-white px-4 py-2 rounded-lg text-sm font-bold shadow-sm">
        ...
        {activeStep === 3 && (
          <div className="space-y-4 animate-fade-in">
            ...
            <button onClick={() => setActiveStep(4)} className="mt-6 bg-zinc-900 hover:bg-zinc-800 text-white px-4 py-2 rounded-lg text-sm font-bold shadow-sm">
              Confirm & Select Form
            </button>
          </div>
        )}
        ...
        {activeStep === 4 && (
          <div className="space-y-4 animate-fade-in text-center py-10">
            ...
            <div className="mt-8">
              <button onClick={() => setActiveStep(5)} className="bg-zinc-900 hover:bg-zinc-800 text-white px-6 py-2.5 rounded-lg text-sm font-bold shadow-sm">
        ...
        {activeStep === 5 && (
          <div className="space-y-4 animate-fade-in text-center py-10">
            ...
            <button onClick={() => setActiveStep(6)} className="flex items-center justify-center gap-2 mx-auto bg-indigo-600 hover:bg-indigo-700 text-white px-6 py-2.5 rounded-lg text-sm font-bold shadow-sm">
        ...
        {activeStep === 6 && (
          <div className="space-y-4 animate-fade-in text-center py-10">
            ...
            <div className="flex justify-center gap-4">
              <button className="flex items-center gap-2 bg-white border border-zinc-200 hover:bg-zinc-50 text-zinc-800 px-4 py-2 rounded-lg text-sm font-bold shadow-sm">
                <Download className="w-4 h-4 text-indigo-600" /> Export JSON
              </button>
              <button onClick={() => setActiveStep(7)} className="flex items-center gap-2 bg-emerald-600 hover:bg-emerald-700 text-white px-4 py-2 rounded-lg text-sm font-bold shadow-sm">
...
with open("src/components/compliance/IncomeTaxComputationTab.tsx", "w") as f:
    f.write(content)
